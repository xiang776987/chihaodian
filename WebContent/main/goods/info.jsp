...
<body>
				...
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" id="goods_old_price"
							   placeholder="请填写原价" value="${list.goods_old_price}" class="input-text" style="width: 80%">
					</div>
				</div>
				<br>
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" id="order_total"
							   placeholder="请填写商品总数" value="${list.order_total}" class="input-text" style="width: 80%">
					</div>
				</div>
				<br>
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" id="single_quantity"
							   placeholder="请填写单次购买数量" value="${list.single_quantity}" class="input-text" style="width: 80%">
					</div>
				</div>
				<br>
				<div class="row cl">
					...
					<div class="formControls col-10">
						<input type="text" id="hxyzm"
							   placeholder="请填写核销验证码" value="${list.hxyzm}" class="input-text" style="width: 80%">
					</div>
				</div>
				<br>
			<div class="row cl">
	...
	function add(){
		...
		$.ajax({
			...
			+'&goods_price='+goods_price+'&goods_detail='+goods_detail+'&goods_id='+goods_id+'&is_coupon='+is_coupon
